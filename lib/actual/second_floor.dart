...
class SecondFloorDemo extends StatefulWidget {
  SecondFloorDemo({Key key}) : super(key: key);

  @override
  createState() => _SecondFloorDemoState();
}

class _SecondFloorDemoState extends State<SecondFloorDemo> {
  // 总数
  int _count = 20;
      ...
      body: Column(children: <Widget>[
        ...
        Expanded(
          child: EasyRefresh.custom(
              header: LinkHeader(_linkNotifier,
                  extent: 70.0,
              ...
              onRefresh: () async {
                ...
                await Future.delayed(
                    Duration(seconds: 2), () => setState(() => _count = 20));
              },
              onLoad: () async {
                await Future.delayed(
                    Duration(seconds: 2), () => setState(() => _count += 20));
...
class SecondFloorWidget extends StatefulWidget {
  ...
  @override
  createState() => SecondFloorWidgetState();
}
            ...
            child: Stack(children: <Widget>[
              Positioned(
                  ...
                  child: Container(
                      ...
                      child:
                      Image.asset('images/left.png', fit: BoxFit.cover))),
              Positioned(
                  bottom: 0.0,
                  left: 0.0,
                  right: 0.0,
